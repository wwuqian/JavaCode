...
texts = html.xpath("//*[@class='List']/div/div[@class='List-item']")

for tr in texts:
    em = tr.xpath("./div/h2[@class='ContentItem-title']/div/a/span/em/text()")
    print(em)
    title = tr.xpath("./div/h2[@class='ContentItem-title']/div/a/span/text()")
    print(title)
